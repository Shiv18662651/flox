                      ...
                      >
                        <span className="flex items-center gap-1.5">
                          <span className="material-symbols-outlined text-base">
                            {pos === "bottom-left" ? "align_horizontal_left" : "align_horizontal_right"}
                          </span>
          ...
          <div className="col-span-12 lg:col-span-4">
            <div className="sticky top-6 space-y-4">
              ...
              <div className="bg-primary-fixed rounded-xl p-4 flex gap-3">
                <span className="material-symbols-outlined text-on-primary-fixed-variant text-xl flex-shrink-0 mt-0.5">
                  lightbulb
                </span>
                <div>
